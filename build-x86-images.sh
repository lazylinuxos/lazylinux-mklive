...
build_variant() {
    ...
    case $variant in
        ...
        xfce)
            ...
            SERVICES="$SERVICES dbus lightdm NetworkManager polkitd podman docker containerd tlp cupsd bluetoothd cronie snooze-daily socklog-unix nanoklogd preload nix-daemon smbd"
